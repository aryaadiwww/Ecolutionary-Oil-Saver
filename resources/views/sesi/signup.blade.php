...
<body>
    <div class="form-wrapper">
        <main class="form-side">
            ...
            <form class="my-form" action="{{ route('req.register') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @if (session('error'))
                    <script>
                ...
                <div class="text-field">
                    ...
                    <input type="text" id="tlp" name="tlp" autocomplete="off" placeholder="Your number"
                        required />
                </div>
                <div class="text-field">
                    <label for="email">Email</label>
                    <input type="email" id="email" value="{{ Session::get('email') }}" name="email"
                        autocomplete="on" placeholder="you@example.com" required />
                ...
                <div class="photo-field">
                    ...
                    <input type="file" accept=".png, .jpg, .jpeg" id="inputFoto" name="foto"
                        onchange="previewImg()">
                ...
                <div class="my-form__actions">
                    <div class="my-form__row">
                        ...
                        <a href="{{ route('login') }}" title="Reset Password"> Sign In Now </a>
                    </div>
                </div>
            </form>
        </main>
